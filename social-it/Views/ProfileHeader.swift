...
class ProfileTableViewHeader: UIView {
    ...
    private let userBioLabel: UILabel = {
        ...
        label.textColor = .label
        label.text = "iOS Developer Enthusiast"
        return label
    }()
    ...
    private let displayNameLabel: UILabel = {
        let label = UILabel()
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "Jundullah Ilhaq Aulia"
    ...
    private func configureConstraints() {
        let profileHeaderImageViewConstraints = [
            ...
            profileHeaderImageView.heightAnchor.constraint(equalToConstant: 175)
        ]
        ...
        let sectionStackConstraints = [
            ...
            sectionStack.topAnchor.constraint(equalTo: followingCountLabel.bottomAnchor, constant: 10),
